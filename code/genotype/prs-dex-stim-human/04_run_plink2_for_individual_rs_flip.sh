...
/binder/mgp/code/plink2/plink2 --score "${prs_res_dir}/${traits[$itrait]}/${cohort_short}_${traits[$itrait]}_all_chromosomes.flipRisk" 2 4 6 \
                               --out "${prs_res_dir}/${traits[$itrait]}/${cohort_short}_${traits[$itrait]}_individual_rs_plink_out" \
                               --bfile $cohort
