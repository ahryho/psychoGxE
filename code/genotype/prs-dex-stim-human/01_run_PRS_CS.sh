...
# traits=("AD" "ADHD" "ASD" "BIP" "cannabis" "chronotype" "CP" "crossDisorder" "EA" "extraversion" "intelligence" "insomnia" "loneliness" "MDD" "neuroticism" "neuroticism2" "resilience" "SCZ" "SESA" "sleepDuration" "suicide")
traits=("BIP" "cannabis" "chronotype" "CP" "crossDisorder" "EA" "extraversion" "intelligence" "insomnia" "loneliness" "MDD" "neuroticism" "neuroticism2" "resilience" "SCZ" "SESA" "sleepDuration" "suicide")
ntraits=( ${#traits[@]} )
IFS=$'\n'
