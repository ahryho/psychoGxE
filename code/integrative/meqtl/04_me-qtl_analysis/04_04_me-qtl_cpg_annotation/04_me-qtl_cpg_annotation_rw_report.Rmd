...
out.dir.pre  <- paste0(dir.pre, "output/data/integrative/matrixEQTL/meqtls/with_missingness/")
...
```{r include = F, eval = T}
delta.meqtl.snp.anno.rds              <- readRDS(paste0(out.dir.pre, "annotation/cpgs/meqtls_cpg_annotated_withChIPseeker_delta.rds"))
veh.meqtl.snp.anno.rds                <- readRDS(paste0(out.dir.pre, "annotation/cpgs/meqtls_cpg_annotated_withChIPseeker_veh.rds"))
dex.meqtl.snp.anno.rds                <- readRDS(paste0(out.dir.pre, "annotation/cpgs/meqtls_cpg_annotated_withChIPseeker_dex.rds"))
```
...
## Delta vs Baseline
```{r}
gen.loc.enrich.perm.rslt <- fread(paste0(out.dir.pre, "enrichment/cpgs/meqtl_cpgs_relation_to_island_enrichment_perm.csv"))
```
...
## Delta vs Baseline
```{r}
gen.loc.enrich.perm.rslt <- fread(paste0(out.dir.pre, "enrichment/cpgs/meqtl_cpgs_chipseeker_enrichment_perm_delta_vs_veh.csv"))
```
...
## Delta vs All
```{r}
gen.loc.enrich.perm.rslt <- fread(paste0(out.dir.pre, "enrichment/cpgs/meqtl_cpgs_chipseeker_enrichment_perm_delta_vs_all.csv"))
```
